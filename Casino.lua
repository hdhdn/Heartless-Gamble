...
if isfile and writefile and typeof(isfile) == 'function' and typeof(writefile) == 'function' then
	if not isfile('PromptedDiscordCFCommunityRRRRR.txt') then
		...
		Module.Prompt({
			invite = "https://discord.gg/FtKP7GRmHG",
			name = "Heartless Gamblers and Beggers",
		})
	end
end
...
function webhook(...)
	...
	local a = {
		["title"] = "> Ghost's Casino ™ | **" .. Players.LocalPlayer.Name .. " got donated! :D**",
		["description"] = "https://discord.gg/FtKP7GRmHG",
		["type"] = "rich",
...
task.spawn(function()
	while true do
		...
		boothText:FireServer('<stroke color="#444444" thickness="1"><font size="9"><font color= "#FFB300"><font face="DenkOne">💸         Win Bobux!         💸 -----💸-Golden Casino-💸-  💸          .help to play        💸</font></font></font></stroke>', "booth")
		task.wait(3)
		boothText:FireServer('<stroke color="#444444" thickness="1"><font size="9"><font color= "#FFB300"><font face="DenkOne">💸         Win Bobux!         💸 ----💸-Heartless Gamble-💸--  💸          .help to play        💸</font></font></font></stroke>', "booth")
		task.wait(3)
		boothText:FireServer('<stroke color="#444444" thickness="1"><font size="9"><font color= "#FFB300"><font face="DenkOne">💸         Win Bobux!         💸 ---💸-Heartless Gamble-💸---  💸          .help to play        💸</font></font></font></stroke>', "booth")
		task.wait(3)
		boothText:FireServer('<stroke color="#444444" thickness="1"><font size="9"><font color= "#FFB300"><font face="DenkOne">💸         Win Bobux!         💸 --💸-Heartless Gamble-💸----  💸          .help to play        💸</font></font></font></stroke>', "booth")
